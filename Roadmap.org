...
* TODO Clean all the global scope caches by nulling them at ready()
...
*** TODO If there isn't enough total points to enter the next level then finish game button appears with a different image in it and different end screen.
