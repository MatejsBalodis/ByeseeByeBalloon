...
* TODO Looks like there is still some problem, when mouse is put on the last item and bar is pushed to the left side at some moment the very left item turns on full opacity.
