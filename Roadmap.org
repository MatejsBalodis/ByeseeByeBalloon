...
* TODO Change the appropriate clamps to mins.
* TODO Implement transitions between scenes.
** Fade in and fade out.
*** TODO Both graphics and music. [1/2]
**** DONE Graphics [0/0]
***** DONE Menu scene [3/3]
****** DONE Start button
****** DONE Options button
...
**** Level 0 required score
***** 500
**** Level 1 required score
***** 600
**** Level 2 required score
***** 700
**** Level 3 required score
***** 750
**** Level 4 required score
***** 800
**** Level 5 required score
***** 900
**** Level 6 required score
***** 950
**** Level 7 required score
***** 1000
**** Level 8 required score
***** 1050
**** Level 9 required score
***** 1250
