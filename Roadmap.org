...
* TODO Item bar must not be draggable if invisible (White arrows should not appear)
* TODO Level complete items fade in and out instead of just popping in and out.
* TODO White arrow appears too soon on the right side when the selection bar is less wide than the screen width.
